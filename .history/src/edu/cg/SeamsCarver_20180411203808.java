...
public class SeamsCarver extends ImageProcessor {
	...
	private MinPixelTupple findMinCost(int x, int y) {
		...
		//TODO: check impact of max
		Float.MAX_VALUE;
		cLeft = (x > 0) ? cLeft + getMagnitudeDiff(y - 1 , x , y , x + 1) : 0; 
		cRight = (x > 0) ? cRight getMagnitudeDiff(y - 1 , x , y , x + 1) : 0; 
		cVertical = (x > 0) ? cLeft getMagnitudeDiff(y - 1 , x , y , x + 1) : 0; 
