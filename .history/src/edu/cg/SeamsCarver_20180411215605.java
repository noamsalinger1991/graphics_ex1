...
public class SeamsCarver extends ImageProcessor {
	...
	public SeamsCarver(Logger logger, BufferedImage workingImage,
		...
		this.seamsArray = new int[this.numOfSeams][this.inHeight];
		this.greyImg = this.getGrayScaleIMG();
		for(; this.seamsRemoved < this.numOfSeams ;this.seamsRemoved++){
			calculateM_Matrix();
			removeSeamFromWorking();
		}		
	}
	
	//remove the seam from the 
	private void removeSeamFromWorking() {
